...
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.117:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.106:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.114:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.115:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.113:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.110:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.101:/home/pi/listener
scp -o StrictHostKeyChecking=no OnCamera.py pi@192.168.0.116:/home/pi/listener
